...
import { UpdateAdminPasswordArgs } from "../types/typegraphql/args/updateAdmin.arg.type";
import {
  Args,
  Ctx,
  Field,
...
import { ConfirmTokenOrCodeArgsType } from "../types/typegraphql/args/confirmEmail.arg.type";
import { ForgotPasswordArgs } from "../types/typegraphql/args/forgotPassword.arg.type";
import { LoginArgsType } from "../types/typegraphql/args/login.arg.type";
import { ResetPasswordArgs } from "../types/typegraphql/args/resetPassword.arg.type";
import { JwtVerifyWithPayloadType } from "../types/jwtVerifyWithPayload.type";
import { MyContext } from "../types/myContext.type";
import { sendConfirmationEmail } from "../utils/sendConfirmationEmail.util";
import { EmailTypes, sendEmail } from "../utils/sendEmail.util";
...
export class AuthResolver {
  ...
  async login(
    ...
    const admin = await ORM.Admin.findOne({
