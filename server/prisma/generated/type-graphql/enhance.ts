...
const modelsInfo = {
  Admin: ["id", "email", "fname", "lname", "createdAt", "updatedAt"],
...
const inputsInfo = {
  AdminWhereInput: ["AND", "OR", "NOT", "id", "email", "fname", "lname", "about", "messages", "projects", "apikey", "password", "createdAt", "updatedAt"],
  AdminOrderByWithRelationInput: ["id", "email", "fname", "lname", "about", "messages", "projects", "apikey", "password", "createdAt", "updatedAt"],
  AdminWhereUniqueInput: ["id", "email"],
  AdminOrderByWithAggregationInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "_count", "_max", "_min"],
  AdminScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  ...
  AdminCreateInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "about", "messages", "projects"],
  AdminUpdateInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "about", "messages", "projects"],
  AdminCreateManyInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  AdminUpdateManyMutationInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  ...
  AdminCountOrderByAggregateInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  AdminMaxOrderByAggregateInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  AdminMinOrderByAggregateInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  ...
  AdminCreateWithoutProjectsInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "about", "messages"],
  ...
  AdminUpdateWithoutProjectsInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "about", "messages"],
  ...
  AdminCreateWithoutAboutInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "messages", "projects"],
  AdminCreateOrConnectWithoutAboutInput: ["where", "create"],
  AdminUpsertWithoutAboutInput: ["update", "create"],
  AdminUpdateWithoutAboutInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "messages", "projects"],
  AdminCreateWithoutMessagesInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "about", "projects"],
  AdminCreateOrConnectWithoutMessagesInput: ["where", "create"],
  AdminUpsertWithoutMessagesInput: ["update", "create"],
  AdminUpdateWithoutMessagesInput: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "about", "projects"],
...
const outputsInfo = {
  ...
  AdminGroupBy: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "_count", "_min", "_max"],
  ...
  AdminCountAggregate: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt", "_all"],
  AdminMinAggregate: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
  AdminMaxAggregate: ["id", "email", "fname", "lname", "apikey", "password", "createdAt", "updatedAt"],
