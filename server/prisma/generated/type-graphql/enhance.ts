...
const modelsInfo = {
  Admin: ["id", "email", "fname", "lname", "confirmed", "createdAt", "updatedAt"],
  Project: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
...
const inputsInfo = {
  AdminWhereInput: ["AND", "OR", "NOT", "id", "email", "fname", "lname", "confirmed", "about", "messages", "projects", "apikey", "password", "createdAt", "updatedAt"],
  AdminOrderByWithRelationInput: ["id", "email", "fname", "lname", "confirmed", "about", "messages", "projects", "apikey", "password", "createdAt", "updatedAt"],
  AdminWhereUniqueInput: ["id", "email"],
  AdminOrderByWithAggregationInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "_count", "_max", "_min"],
  AdminScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  ProjectWhereInput: ["AND", "OR", "NOT", "id", "name", "image", "github_url", "app_url", "description", "tech_categories", "questions", "sketches", "admin", "admin_id", "createdAt", "updatedAt"],
  ProjectOrderByWithRelationInput: ["id", "name", "image", "github_url", "app_url", "description", "tech_categories", "questions", "sketches", "admin", "admin_id", "createdAt", "updatedAt"],
  ProjectWhereUniqueInput: ["id"],
  ProjectOrderByWithAggregationInput: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt", "_count", "_max", "_min"],
  ProjectScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ...
  AdminCreateInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "about", "messages", "projects"],
  AdminUpdateInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "about", "messages", "projects"],
  AdminCreateManyInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  AdminUpdateManyMutationInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  ProjectCreateInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "questions", "sketches", "admin"],
  ProjectUpdateInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "questions", "sketches", "admin"],
  ProjectCreateManyInput: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ProjectUpdateManyMutationInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt"],
  ...
  AdminCountOrderByAggregateInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  AdminMaxOrderByAggregateInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  AdminMinOrderByAggregateInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  ...
  ProjectCountOrderByAggregateInput: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ProjectMaxOrderByAggregateInput: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ProjectMinOrderByAggregateInput: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ...
  ProjectCreateWithoutAdminInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "questions", "sketches"],
  ...
  ProjectScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ...
  AdminCreateWithoutProjectsInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "about", "messages"],
  ...
  AdminUpdateWithoutProjectsInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "about", "messages"],
  ...
  ProjectCreateWithoutTech_categoriesInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "questions", "sketches", "admin"],
  ...
  ProjectUpdateWithoutTech_categoriesInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "questions", "sketches", "admin"],
  ...
  ProjectCreateWithoutQuestionsInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "sketches", "admin"],
  ...
  ProjectUpdateWithoutQuestionsInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "sketches", "admin"],
  ...
  ProjectCreateWithoutSketchesInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "questions", "admin"],
  ProjectCreateOrConnectWithoutSketchesInput: ["where", "create"],
  ProjectUpsertWithoutSketchesInput: ["update", "create"],
  ProjectUpdateWithoutSketchesInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "questions", "admin"],
  AdminCreateWithoutAboutInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "messages", "projects"],
  AdminCreateOrConnectWithoutAboutInput: ["where", "create"],
  AdminUpsertWithoutAboutInput: ["update", "create"],
  AdminUpdateWithoutAboutInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "messages", "projects"],
  AdminCreateWithoutMessagesInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "about", "projects"],
  AdminCreateOrConnectWithoutMessagesInput: ["where", "create"],
  AdminUpsertWithoutMessagesInput: ["update", "create"],
  AdminUpdateWithoutMessagesInput: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "about", "projects"],
  ...
  ProjectCreateManyAdminInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt"],
  ...
  ProjectUpdateWithoutAdminInput: ["id", "name", "image", "github_url", "app_url", "description", "createdAt", "updatedAt", "tech_categories", "questions", "sketches"],
...
const outputsInfo = {
  ...
  AdminGroupBy: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregateProject: ["_count", "_min", "_max"],
  ProjectGroupBy: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt", "_count", "_min", "_max"],
  ...
  AdminCountAggregate: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt", "_all"],
  AdminMinAggregate: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  AdminMaxAggregate: ["id", "email", "fname", "lname", "confirmed", "apikey", "password", "createdAt", "updatedAt"],
  ProjectCount: ["tech_categories", "questions", "sketches"],
  ProjectCountAggregate: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt", "_all"],
  ProjectMinAggregate: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
  ProjectMaxAggregate: ["id", "name", "image", "github_url", "app_url", "description", "admin_id", "createdAt", "updatedAt"],
