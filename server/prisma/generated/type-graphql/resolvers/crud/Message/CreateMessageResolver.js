...
let CreateMessageResolver = class CreateMessageResolver {
    async createMessage(ctx, info, args) {
...
], CreateMessageResolver.prototype, "createMessage", null);
CreateMessageResolver = __decorate([
