...
exports.UpdateMessageResolver = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const graphql_fields_1 = __importDefault(require("graphql-fields"));
const UpdateMessageArgs_1 = require("./args/UpdateMessageArgs");
const Message_1 = require("../../../models/Message");
const helpers_1 = require("../../../helpers");
let UpdateMessageResolver = class UpdateMessageResolver {
    async updateMessage(ctx, info, args) {
...
], UpdateMessageResolver.prototype, "updateMessage", null);
UpdateMessageResolver = __decorate([
    TypeGraphQL.Resolver(_of => Message_1.Message)
], UpdateMessageResolver);
exports.UpdateMessageResolver = UpdateMessageResolver;
