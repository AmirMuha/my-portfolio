...
exports.UpsertMessageResolver = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const graphql_fields_1 = __importDefault(require("graphql-fields"));
const UpsertMessageArgs_1 = require("./args/UpsertMessageArgs");
const Message_1 = require("../../../models/Message");
const helpers_1 = require("../../../helpers");
let UpsertMessageResolver = class UpsertMessageResolver {
    async upsertMessage(ctx, info, args) {
...
], UpsertMessageResolver.prototype, "upsertMessage", null);
UpsertMessageResolver = __decorate([
    TypeGraphQL.Resolver(_of => Message_1.Message)
], UpsertMessageResolver);
exports.UpsertMessageResolver = UpsertMessageResolver;
