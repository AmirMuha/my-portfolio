...
exports.DeleteMessageResolver = void 0;
const TypeGraphQL = __importStar(require("type-graphql"));
const graphql_fields_1 = __importDefault(require("graphql-fields"));
const DeleteMessageArgs_1 = require("./args/DeleteMessageArgs");
const Message_1 = require("../../../models/Message");
const helpers_1 = require("../../../helpers");
let DeleteMessageResolver = class DeleteMessageResolver {
    async deleteMessage(ctx, info, args) {
...
], DeleteMessageResolver.prototype, "deleteMessage", null);
DeleteMessageResolver = __decorate([
    TypeGraphQL.Resolver(_of => Message_1.Message)
], DeleteMessageResolver);
exports.DeleteMessageResolver = DeleteMessageResolver;
