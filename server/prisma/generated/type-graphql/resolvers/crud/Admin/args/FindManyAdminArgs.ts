...
export class FindManyAdminArgs {
  ...
  distinct?: Array<"id" | "email" | "fname" | "lname" | "linkedIn" | "whatsapp" | "instagram" | "github" | "heroImage" | "stack" | "resumes" | "confirmed" | "isPublished" | "stacks" | "apikey" | "password" | "createdAt" | "updatedAt"> | undefined;
}
