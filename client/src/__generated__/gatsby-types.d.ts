...
type runmediaamirmuha86E6E47Be6E46CbdProjectsApplicationsportfolioclientsrcpagesprojectsTsx3957772094QueryVariables = Exact<{ [key: string]: never; }>;


type runmediaamirmuha86E6E47Be6E46CbdProjectsApplicationsportfolioclientsrcpagesprojectsTsx3957772094Query = { readonly portfolio: { readonly projects: ReadonlyArray<Pick<Portfolio_Project, 'id' | 'image' | 'app_url' | 'type' | 'name' | 'github_url' | 'summary'>> } };
