...
type runmediaamirmuha86E6E47Be6E46CbdProjectsApplicationsportfolioclientsrcpagesindexTsx3944538668QueryVariables = Exact<{ [key: string]: never; }>;


type runmediaamirmuha86E6E47Be6E46CbdProjectsApplicationsportfolioclientsrcpagesindexTsx3944538668Query = { readonly portfolio: { readonly projects: ReadonlyArray<Pick<Portfolio_Project, 'id' | 'github_url' | 'summary' | 'app_url' | 'image' | 'name' | 'type' | 'updatedAt' | 'createdAt'>> } };
